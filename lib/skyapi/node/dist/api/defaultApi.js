...
var DefaultApi = (function () {
        ...
        return new Promise(function (resolve, reject) {
            localVarRequest(localVarRequestOptions, function (error, response, body) {
                if (error) {
                    ...
                    body = models_1.ObjectSerializer.deserialize(body, "Array<InlineResponse200>");
                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                        resolve({ response: response, body: body });
                    }
                    else {
    ...
    DefaultApi.prototype.blocksGet = function (start, end, seqs, options) {
        ...
        if (seqs !== undefined) {
            localVarQueryParameters['seqs'] = models_1.ObjectSerializer.serialize(seqs, "Array<number>");
        }
        Object.assign(localVarHeaderParams, options.headers);
        var localVarUseFormData = false;
        var localVarRequestOptions = {
    ...
    DefaultApi.prototype.explorerAddress = function (address, options) {
        if (options === void 0) { options = { headers: {} }; }
        var localVarPath = this.basePath + '/api/v1/explorer/address';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        if (address !== undefined) {
        ...
        return new Promise(function (resolve, reject) {
            localVarRequest(localVarRequestOptions, function (error, response, body) {
                if (error) {
                    ...
                    body = models_1.ObjectSerializer.deserialize(body, "Array<InlineResponse2002>");
                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                        resolve({ response: response, body: body });
                    }
                    else {
    ...
    DefaultApi.prototype.transaction = function (txid, encoded, options) {
        ...
        if (encoded !== undefined) {
            localVarQueryParameters['encoded'] = models_1.ObjectSerializer.serialize(encoded, "boolean");
        }
        Object.assign(localVarHeaderParams, options.headers);
        var localVarUseFormData = false;
        var localVarRequestOptions = {
    ...
    DefaultApi.prototype.transactionInject = function (rawtx, options) {
        if (options === void 0) { options = { headers: {} }; }
        var localVarPath = this.basePath + '/api/v2/transaction/inject';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
    ...
    DefaultApi.prototype.walletSpent = function (id, dst, coins, password, options) {
        if (options === void 0) { options = { headers: {} }; }
        var localVarPath = this.basePath + '/api/v1/wallet/spend';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        if (id === null || id === undefined) {
        ...
        localVarHeaderParams['id'] = models_1.ObjectSerializer.serialize(id, "string");
        localVarHeaderParams['dst'] = models_1.ObjectSerializer.serialize(dst, "string");
        localVarHeaderParams['coins'] = models_1.ObjectSerializer.serialize(coins, "string");
        localVarHeaderParams['password'] = models_1.ObjectSerializer.serialize(password, "string");
        Object.assign(localVarHeaderParams, options.headers);
        var localVarUseFormData = false;
        var localVarRequestOptions = {
    ...
    DefaultApi.prototype.walletTransaction = function (body, options) {
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(body, "InlineObject")
        };
        this.authentications.csrfAuth.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
        ...
        return new Promise(function (resolve, reject) {
            localVarRequest(localVarRequestOptions, function (error, response, body) {
                if (error) {
                    ...
                    body = models_1.ObjectSerializer.deserialize(body, "Array<InlineResponse2005>");
                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                        resolve({ response: response, body: body });
                    }
                    else {
